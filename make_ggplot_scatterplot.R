...
p9 <- p9 + geom_rect(aes(xmin=50, xmax = 62.5, ymin = 0, ymax = 2), fill = "pink", alpha = 0.01)
p9 <- p9 + geom_rect(aes(xmin=62.5, xmax = 75, ymin = 0, ymax = 2), fill = "yellow", alpha = 0.01)
...
p10 <- p10 + geom_rect(aes(xmin=50, xmax = 62.5, ymin = 0, ymax = 2), fill = "pink", alpha = 0.01)
p10 <- p10 + geom_rect(aes(xmin=62.5, xmax = 75, ymin = 0, ymax = 2), fill = "yellow", alpha = 0.01)
